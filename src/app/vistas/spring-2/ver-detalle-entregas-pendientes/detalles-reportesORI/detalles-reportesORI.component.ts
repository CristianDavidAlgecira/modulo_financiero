...
@Component({
  ...
  standalone: true,
  imports: [],
  templateUrl: './detalles-reportesORI.component.html',
  styleUrl: './detalles-reportesORI.component.css'
})
export class DetallesReportesORIComponent implements OnInit {
  ...
  loadOptions(): void {
    ...
    this.apiMFService.getORI(this.datosState.nit, this.datosState.idHeredado).subscribe(
      response => {
